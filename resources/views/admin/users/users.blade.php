                ...
                @foreach ($users as $user)
                    <tr>
                        <td class="text-center">
                            ...
                            @else
                                <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/b/b5/Windows_10_Default_Profile_Picture.svg/512px-Windows_10_Default_Profile_Picture.svg.png?20221210150350" alt="" width="50" height="50">
                            @endif
                        </td>
                        <td>{{$user->name}}</td>
                        <td>{{$user->email}}</tds=>
                        ...
                        <td>
                            <a title="Edit user" href="{{ route('admin.edit_user', ['id' => $user->id]) }}"><span class="material-symbols-outlined">
                                edit
                                </span></a>
                            <a href="{{route('admin.change_pass',['id'=>$user->id])}}" title="Change password"><span class="material-symbols-outlined" style="color:green">
                                key
                                </span></a>&nbsp;<a title="Delete user" href="{{route('admin.delete_user',$user->id)}}"><span class="material-symbols-outlined" style="color:red">
                                    Delete
                                    </span></a>
                        </td>
                    </tr>
