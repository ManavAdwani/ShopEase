...
<head>
    ...
    <title>Sainath mobiles - User banner</title>
...
<body>
    ...
    <div class="container">
        ...
        @endphp
        <form action="{{route('admin.store_user_banner')}}" class="mt-5" method="POST" enctype="multipart/form-data">
            @csrf
            <!-- 2 column grid layout with text inputs for the first and last names -->
            <div class="mb-3">
                <label for="formFileMultiple" class="form-label">Banner</label>
                <input class="form-control" name="banner[]" type="file" id="formFileMultiple" accept="image/*" multiple>
            ...
            <div class="row mb-4"> 
                <div class="col">
                    <div data-mdb-input-init class="form-outline">
                        ...
                        <input type="text" name="banner_name" placeholder="banner Name" id="form6Example1"
                            class="form-control" />
                    </div>
                </div>
            </div>
